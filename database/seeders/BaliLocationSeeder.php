...
class BaliLocationSeeder extends Seeder
{
    public function run(): void
    {
        $destinations = [
            ...
            ['id' => 103, 'name' => 'Legian',    'city' => 'Legian, Badung',    'query' => 'Legian',    'image' => 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=600&q=80', 'count_fallback' => '7+ Villa'],
            ['id' => 104, 'name' => 'Kuta',      'city' => 'Kuta, Badung',      'query' => 'Kuta',      'image' => 'https://images.unsplash.com/photo-1520454974749-a795c5e0b8f0?auto=format&fit=crop&w=600&q=80', 'count_fallback' => '12+ Villa'],
            ...
            ['id' => 107, 'name' => 'Uluwatu',   'city' => 'Uluwatu, Badung',   'query' => 'Uluwatu',   'image' => 'https://images.unsplash.com/photo-1573790387438-4da905039392?auto=format&fit=crop&w=600&q=80', 'count_fallback' => '11+ Villa'],
            ['id' => 108, 'name' => 'Ubud',      'city' => 'Ubud, Gianyar',     'query' => 'Ubud',      'image' => 'https://images.unsplash.com/photo-1549638441-b787d2e11f14?auto=format&fit=crop&w=600&q=80', 'count_fallback' => '14+ Villa'],
            ['id' => 109, 'name' => 'Kintamani', 'city' => 'Kintamani, Bangli', 'query' => 'Kintamani', 'image' => 'https://images.unsplash.com/photo-1518548419970-58e3b4079ab2?auto=format&fit=crop&w=600&q=80', 'count_fallback' => '5+ Villa'],
            ['id' => 110, 'name' => 'Sanur',     'city' => 'Sanur, Denpasar',   'query' => 'Sanur',     'image' => 'https://images.unsplash.com/photo-1604999333679-b86d54738315?auto=format&fit=crop&w=600&q=80', 'count_fallback' => '10+ Villa'],
        ];
