...
export default function PublicFooter() {
    ...
    return (
        <footer className="relative bg-gradient-to-b from-blue-900 via-blue-950 to-blue-950 text-white overflow-hidden">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-10 lg:px-16 xl:px-20 pt-16 sm:pt-20 pb-0">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
                    ...
                    <div className="lg:col-span-4 space-y-5">
                        <Link href="/" className="inline-flex items-center gap-3 group">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] text-blue-400/60 tracking-widest uppercase">Agen Villa Bali</p>
                            </div>
                        </Link>
                        <p className="text-sm leading-relaxed text-blue-200/65 max-w-sm">
                        ...
                        <div className="flex items-center gap-3 pt-1">
                            <a href={`https://wa.me/${whatsappRaw}`} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-blue-500/10 hover:bg-blue-500/25 flex items-center justify-center transition-colors" aria-label="WhatsApp">
                            ...
                            {email && (
                                <a href={`mailto:${email}`} className="w-9 h-9 rounded-full bg-blue-500/10 hover:bg-blue-500/25 flex items-center justify-center transition-colors" aria-label="Email">
                                    <Mail className="w-4 h-4 text-blue-300" />
                                </a>
                            )}
                            <a href="/villas" className="w-9 h-9 rounded-full bg-blue-500/10 hover:bg-blue-500/25 flex items-center justify-center transition-colors" aria-label="Semua Villa">
                    ...
                    <div className="lg:col-span-2 space-y-5">
                        <h3 className="text-xs font-bold text-blue-300 uppercase tracking-[0.15em] font-heading">Jelajahi</h3>
                        <ul className="space-y-2.5">
                            {[
                                ...
                                <li key={link.href}>
                                    <Link href={link.href} className="group inline-flex items-center gap-1.5 text-sm text-blue-200/65 hover:text-white transition-colors">
                    ...
                    {/* ── Populer (2 cols) ── */}
                    <div className="lg:col-span-2 space-y-5">
                        <h3 className="text-xs font-bold text-blue-300 uppercase tracking-[0.15em] font-heading">Populer</h3>
                        <ul className="space-y-2.5">
                            {[
                    ...
                    {/* ── Kontak (4 cols) ── */}
                    <div className="lg:col-span-4 space-y-5">
                        <h3 className="text-xs font-bold text-blue-300 uppercase tracking-[0.15em] font-heading">Kontak</h3>
                            ...
                            {whatsappRaw && (
                                <li>
                                    <a href={`https://wa.me/${whatsappRaw}`} target="_blank" rel="noopener noreferrer"
                                        ...
                                        <div>
                                            <p className="text-sm font-semibold text-white group-hover:text-blue-200 transition-colors">{whatsappDisplay}</p>
                                            <p className="text-xs text-blue-400/60">Hubungi via WhatsApp</p>
                                        </div>
                                    </a>
                                </li>
                            )}
                            {email && (
                                <li>
                                    <a href={`mailto:${email}`}
                                        ...
                                        <div>
                                            <p className="text-sm font-semibold text-white group-hover:text-blue-200 transition-colors">{email}</p>
                                            <p className="text-xs text-blue-400/60">Kirim email</p>
                                        </div>
                                    </a>
                                </li>
                            )}
                            <li>
                                <Link href="/profile" className="flex items-center gap-3 group">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-blue-400/60">Masuk atau daftar</p>
                                    </div>
                                </Link>
                            </li>
                        </ul>
                ...
                {/* ── Bottom Bar ── */}
                <div className="mt-16 sm:mt-20 pt-6 pb-6 border-t border-blue-700/40 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs">
                    <p className="text-blue-400/60 text-center sm:text-left">
                        &copy; {new Date().getFullYear()} {appName}. Semua hak cipta dilindungi.
                    </p>
                    <div className="flex items-center gap-4">
                        <Link href="/villas" className="text-blue-400/60 hover:text-blue-300 transition-colors">Villa</Link>
