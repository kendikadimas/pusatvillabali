...
export default function AuthSplitLayout({
    ...
    return (
        <div className="flex min-h-dvh">
            {/* Left Panel */}
            <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-gradient-to-br from-slate-900 via-emerald-950 to-indigo-950 p-12 lg:flex">
                ...
                <div className="relative z-10 space-y-6">
                    <h2 className="text-4xl font-bold leading-tight tracking-tight text-white">
                        Temukan villa
                        <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-300 to-sky-200">
                            impianmu
                        </span>
                    </h2>
                    <p className="max-w-md text-base leading-relaxed text-emerald-200/70">
                    ...
                    <div className="flex items-center gap-6 pt-4">
                        <div className="flex -space-x-2">
                            {[1, 2, 3, 4].map((i) => (
                                <div
                                    key={i}
                                    className="size-8 rounded-full border-2 border-slate-800 bg-gradient-to-br from-emerald-400 to-indigo-500"
                                />
                            ))}
                        </div>
